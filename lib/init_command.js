...
module.exports = class Command {
    ...
    async run(cwd, args) {
        // 从远程加载最新的模板来选择
        try {
            const res = await this.curl(`https://api.github.com/repos/nianiaJR/fe-init/contents/package.json?ref=master`, {
                method: 'GET',
                dataType: 'json',
                headers: {
            ...
            this.boilerplateMapping = JSON.parse(Base64.decode(res.data.content)).boilerplates;
        } catch (_) {
